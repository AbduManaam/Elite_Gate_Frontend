        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-md backdrop-blur-xs select-none">
            <div className="bg-white border border-outline-variant rounded-xl p-lg shadow-2xl w-[440px] max-w-full flex flex-col gap-md text-left">
                <div className="flex items-center gap-2 border-b border-outline-variant pb-md mb-xs">
                    <span className="material-symbols-outlined text-[24px] text-emerald-600 leading-none">check_circle</span>
                    <div>
                        <h3 className="font-headline-md text-headline-md text-on-surface">API Key Generated</h3>
                        <p className="text-[11px] text-on-surface-variant mt-1">This key is ready for authentication.</p>
                    </div>
                </div>
                ...
                <div className="text-xs text-on-surface-variant flex flex-col gap-1">
                    <span className="font-semibold">Raw API Key</span>
                    <CopyKeyInput value={rawKey} />
                </div>
                ...
                <div className="bg-amber-50 border border-amber-200/50 rounded-lg p-3 text-xs text-amber-800 flex items-start gap-2">
                    ...
                    <div className="flex flex-col gap-0.5 font-sans">
                        <span className="font-bold">Important Security Note</span>
                        <span>This key is only displayed once. Make sure to copy and store it securely. After closing this dialog, it can never be retrieved or viewed again.</span>
                    </div>
                </div>
